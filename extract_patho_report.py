...
from verify import flatten_margins, verify
    ...
    for folder_name in TARGET_FOLDERS:
        ...
        for chart_no in tqdm(chart_dirs, desc=f"Processing {folder_name}"):
            ...
            try:
                ...
                # flatten the margins list into tabular columns + a JSON cell for audit
                margins = llm_json.get("margins")
                row_data.update(flatten_margins(margins))
                row_data["margins"] = json.dumps(margins, ensure_ascii=False) if margins else ""
